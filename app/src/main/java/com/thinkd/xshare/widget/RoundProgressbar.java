...
import static com.thinkd.xshare.util.DensityUtil.dip2px;

/**
 * Created by 百思移动 on 2017/11/16.
 */
...
public class RoundProgressbar extends View{
    ...
    public RoundProgressbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideColor = a.getColor(R.styleable.CustomCircleProgressBar_outside_color, ContextCompat.getColor(getContext(), R.color.color_3c38ff));
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, dip2px(getContext(), 60.0f));
        insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color, ContextCompat.getColor(getContext(), R.color.color_ffd129));
        progressTextColor = a.getColor(R.styleable.CustomCircleProgressBar_progress_text_color, ContextCompat.getColor(getContext(), R.color.color_3c38ff));
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, dip2px(getContext(), 14.0f));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, dip2px(getContext(), 10.0f));
    ...
    private void startAnim(float startProgress) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                RoundProgressbar.this.progress = (float) animation.getAnimatedValue();
                postInvalidate();
            }
        });
